...
use App\Mcp\Tools\Admin\AdminGenerateEventPosterImageTool;
...
class AdminServer extends MajlisIlmuServer
{
    ...
    protected array $tools = [
        ...
        AdminGenerateEventCoverImageTool::class,
        AdminGenerateEventPosterImageTool::class,
