...
class MemberUploadEventPosterImageTool extends AbstractMemberTool
{
    ...
    protected string $description = 'Upload and save a 4:5 portrait marketing poster for an accessible Ahli event. Accepts a ChatGPT-generated image via {download_url, file_id} or a base64-encoded image via {content_base64}. Use the member-event-poster-image-prompt to get the recommended prompt and reference images before generating.';
