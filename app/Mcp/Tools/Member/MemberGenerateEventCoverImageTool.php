...
#[IsDestructive(true)]
#[IsOpenWorld(true)]
class MemberGenerateEventCoverImageTool extends AbstractMemberTool
{
    use GeneratesEventImageResponse;

    protected string $name = 'member-generate-event-cover-image';

    protected string $title = 'Generate Event Cover Image';

    protected string $description = 'Generate and save a 16:9 website/mobile-app cover image for one accessible Ahli event. The tool builds a prompt from event data, relation data, and selected available media, attaches suitable reference images, generates the image, normalizes it to 16:9, and stores it in the Event cover media collection.';
