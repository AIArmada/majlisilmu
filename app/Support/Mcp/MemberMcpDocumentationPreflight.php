...
class MemberMcpDocumentationPreflight
{
    ...
    {
        $message = sprintf(
            'Documentation preflight required before calling [%s]. Fetch `docs-member-mcp-guide` or read `%s` in the current initialized MCP session, then retry the operational tool call.',
            $toolName,
