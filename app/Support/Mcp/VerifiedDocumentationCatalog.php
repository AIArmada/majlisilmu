...
class VerifiedDocumentationCatalog
{
    ...
    public function all(): array
    {
        return array_values(array_filter([
            [
                'id' => 'docs-mcp-guide',
                'title' => 'MajlisIlmu MCP Guide',
                'description' => 'Verified guide for MCP auth, transport rules, discovery primitives, capability matrix, media rules, and current admin/member write behavior.',
                'resource_uri' => 'file://docs/MAJLISILMU_MCP_GUIDE.md',
                'url' => 'file://docs/MAJLISILMU_MCP_GUIDE.md',
                'relative_path' => 'docs/MAJLISILMU_MCP_GUIDE.md',
