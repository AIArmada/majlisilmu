    ...
    public function submitEvent(?User $user): array
    {
        ...
        return [
            ...
            'fields' => [
                ...
                $this->field('submission_country_code', 'string', required: false),
                $this->field('submission_country_key', 'string', required: false),
            ...
            'conditional_rules' => [
                ...
                ['field' => 'submission_country_id', 'required_when_missing' => ['submission_country_code', 'submission_country_key']],
    ...
    public function submitInstitution(): array
    {
        ...
        return [
            ...
            'fields' => [
                ...
                $this->field('address.country_id', 'integer', required: false, default: $preferredCountryId, catalog: route('api.client.catalogs.countries')),
    ...
    public function submitSpeaker(): array
    {
        return [
            ...
            'fields' => [
                ...
                $this->field('address', 'object', required: true),
                $this->field('address.country_id', 'integer', required: false, catalog: route('api.client.catalogs.countries')),
                $this->field('address.country_code', 'string', required: false),
                $this->field('address.country_key', 'string', required: false),
