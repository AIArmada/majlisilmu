...
it('keeps generated_until in sync when additional recurring sessions are generated by the rule update flow', function () {
    ...
    $rule->forceFill(['status' => ScheduleState::Active])->saveQuietly();
    $rule->refresh();
