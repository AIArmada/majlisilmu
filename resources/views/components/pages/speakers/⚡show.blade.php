        ...
        <div class="container mx-auto px-6 lg:px-12 relative z-20 -mt-32 pb-20">
            <div
                ...
                <div
                    ...
                    @else
                        <div
                            class="w-full h-full flex items-center justify-center bg-emerald-50 text-emerald-600 font-bold text-5xl">
                ...
                <div class="flex-grow pt-4">
                    <h1 class="font-heading text-3xl md:text-5xl font-bold text-slate-900 mb-2">{{ $speaker->name }}</h1>
                    @if($speaker->title)
                        <span
                            class="inline-block bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-sm font-semibold mb-4">{{ $speaker->title }}</span>
                    @endif
                                        ...
                                        <div class="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center gap-2 text-sm text-slate-500 mt-1">
                                                    ...
                                                    <span>{{ $event->institution?->name ?? 'Online' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
