                        ...
                        <div class="mt-7 flex flex-wrap gap-3 animate-fade-in-up" style="--reveal-d: 400ms;">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-xs font-medium text-emerald-200/80">
                                            @if($event->isPrayerRelative())
                                                ...
                                                @if($event->ends_at) —
                                                {{ \App\Support\Timezone\UserDateTimeFormatter::format($event->ends_at, 'g:i A') }}@endif
                                            @else
                            ...
                            @if($showHeroLocationChip)
                                <div
                                    ...
                                    <div
                                        class="flex size-11 shrink-0 items-center justify-center rounded-xl bg-white/10 shadow-inner">
