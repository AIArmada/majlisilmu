                ...
                <div class="grid gap-8 xl:grid-cols-[1.25fr,0.95fr] xl:items-end">
                    <div>
                        ...
                        <p class="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
                            {{ __('Every shared page here stays private to you. Use it to understand how many people visited, responded, signed up, and registered after seeing what you passed along.') }}
                        </p>
                    </div>
